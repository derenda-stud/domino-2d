...
# File sorgente
CFILES  = $(addprefix $(SRCDIR)/, main.c struttura_dati.c controlli.c modalita_interattiva.c)
# File oggetto
OBJECTS = $(addprefix $(OBJDIR)/, main.o struttura_dati.o controlli.o modalita_interattiva.o)
